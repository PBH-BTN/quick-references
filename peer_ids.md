...
| -BW     | BitWombat | | 下载器 |
| -CB     | Shareaza Plus | | 下载器 |
| -CD     | Enhanced CTorrent | | 下载器 |
| -CT     | [CTorrent](http://ctorrent.sourceforge.net/) | | 下载器 |
| -DE     | [Deluge](https://deluge-torrent.org/) | | 下载器 |
| -DT     | 💣💣💣dt/torrent | | **恶意客户端** |
| -DP     | Propogate Data Client | | 下载器 |
| -DL     | DL | | 下载器 |
| -EB     | EBit | | 下载器 |
...
| -SB     | SwiftBit | | 下载器 |
| -SD     | 💣[迅雷在线 (Xunlei)](https://www.xunlei.com/) | 迅雷在线 | 仅下载器 |
| -SG     | GS Torrent | | 下载器 |
| -SN     | ShareNET | | 下载器 |
| -SP     | StellarPlayer | | 下载器 |
| -SZ     | [Shareaza](https://shareaza.sourceforge.io/) | | 下载器 |
| -TG     | Torrent GO | | 下载器 |
| -TN     | Torrent.NET | | 下载器 |
| -TR     | ⭐[Transmission](https://transmissionbt.com/) | | 下载器 |
| -TS     | TorrentStorm | | 下载器 |
| -TT     | [TuoTu](https://tuotu.sourceforge.io/) | | 下载器 |
| -tT     | | | 下载器 |
| -TX     | Torrex Pro | | 下载器 |
| -UL     | uLeecher! | | 下载器 |
| -UE     | µTorrent Embedded | | 下载器 |
...
| BitTorrent Plus! | BitTorrent Plus! | | 下载器 |
| BTDWV-  | Deadman Walking | | 下载器 |
